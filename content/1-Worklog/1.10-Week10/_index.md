...
| Wed | - Set up an automated CI/CD pipeline for the Next.js app via **AWS Amplify Hosting**.<br>- Link the GitHub repository and configure Production build variables. | 25/07/2026 | 25/07/2026 | <https://cloudjourney.awsstudygroup.com/> |
| Thu | - Finalize the project: Conduct a comprehensive review of all worklogs and verify the live demo environments for the final assessment. | 25/07/2026 | 25/07/2026 | |
